...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblShadowsCdfyPixelShader",i=`#define PI 3.1415927
varying vUV: vec2f;
...
fragmentOutputs.color= vec4f(cdfy,0.0,0.0,1.0);}`;e.ShadersStoreWGSL[r]=i;var o={name:r,shader:i};export{o as a};
