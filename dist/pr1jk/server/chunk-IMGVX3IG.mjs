...
import{a as e}from"./chunk-NW7RVBCE.mjs";var i="glowMapGenerationPixelShader",a=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;e.ShadersStoreWGSL[i]=a;var n={name:i,shader:a};export{n as a};
