...
import{a as e}from"./chunk-NW7RVBCE.mjs";var i="iblShadowsCdfyPixelShader",o=`precision highp sampler2D;precision highp samplerCube;
#define PI 3.1415927
varying vec2 vUV;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;e.ShadersStore[i]=o;var t={name:i,shader:o};export{t as a};
