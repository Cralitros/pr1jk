...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="iblShadowsIcdfxPixelShader",r=`#define PI 3.1415927
...
else if (currentPixel.x==icdfWidth-1) {fragmentOutputs.color= vec4f(1.0);} else {var targetValue: f32=fetchCDF(cdfWidth-1)*input.vUV.x;fragmentOutputs.color= vec4f( vec3f(bisect(cdfWidth,targetValue)),1.0);}}`;e.ShadersStoreWGSL[t]=r;var a={name:t,shader:r};export{a};
