...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="iblShadowsIcdfyPixelShader",r=`#define PI 3.1415927
...
else if (currentPixel.y==cdfHeight-2) {fragmentOutputs.color= vec4f(1.0);} else {var targetValue: f32=fetchCDF(cdfHeight-1,currentPixel.x)*input.vUV.y;fragmentOutputs.color= vec4f( vec3f(bisect(cdfHeight,targetValue,currentPixel.x)),1.0);}}`;e.ShadersStoreWGSL[t]=r;var c={name:t,shader:r};export{c as a};
