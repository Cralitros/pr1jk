...
import{a as e}from"./chunk-NW7RVBCE.mjs";var i="iblShadowsIcdfyPixelShader",t=`precision highp sampler2D;
#define PI 3.1415927
...
else if (currentPixel.y==cdfHeight-2) {gl_FragColor=vec4(1.0);} else {float targetValue=fetchCDF(cdfHeight-1,currentPixel.x)*vUV.y;gl_FragColor=vec4(vec3(bisect(cdfHeight,targetValue,currentPixel.x)),1.0);}}`;e.ShadersStore[i]=t;var a={name:i,shader:t};export{a};
