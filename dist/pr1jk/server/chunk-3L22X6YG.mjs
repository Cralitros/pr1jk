...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblShadowsCdfxPixelShader",c=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(vec3(cdfx),1.0);}`;e.ShadersStore[r]=c;var d={name:r,shader:c};export{d as a};
