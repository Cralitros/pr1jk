...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="bayerDitherFunctions",i=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[t]=i;var n="shadowMapFragmentExtraDeclaration",f=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[n]=f;var r="shadowMapPixelShader",a=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[r]=a;var M={name:r,shader:a};export{M as a};
