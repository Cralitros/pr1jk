...
import{a}from"./chunk-NW7RVBCE.mjs";var e="fxaaPixelShader",o=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=TEXTUREFUNC(textureSampler,posM,0.0);
#endif
}`;a.ShadersStore[e]=o;var t={name:e,shader:o};export{t as a};
