...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="iblShadowsIcdfxPixelShader",i=`precision highp sampler2D;
#define PI 3.1415927
...
else if (currentPixel.x==icdfWidth-1) {gl_FragColor=vec4(1.0);} else {float targetValue=fetchCDF(cdfWidth-1)*vUV.x;gl_FragColor=vec4(vec3(bisect(cdfWidth,targetValue)),1.0);}}`;e.ShadersStore[t]=i;var a={name:t,shader:i};export{a};
