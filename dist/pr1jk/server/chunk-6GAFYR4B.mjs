...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="passCubePixelShader",r=`varying var vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;
...
fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,vec3f(uv,-1.001));
#endif
}`;e.ShadersStoreWGSL[t]=r;var a={name:t,shader:r};export{a};
