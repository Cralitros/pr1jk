...
import{a as e}from"./chunk-NW7RVBCE.mjs";var a="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[a]=n;var f="samplerFragmentAlternateDeclaration",o=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]=o;var t="pbrFragmentSamplersDeclaration",c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[t]=c;var l="subSurfaceScatteringFunctions",d=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[l]=d;var s="pbrHelperFunctions",E=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[s]=E;var m="pbrDirectLightingSetupFunctions",S=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
return result;}`;e.IncludesShadersStoreWGSL[m]=S;var R="pbrDirectLightingFalloffFunctions",p=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[R]=p;var v="pbrDirectLightingFunctions",u=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[v]=u;var C="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[C]=A;var I="pbrBlockAlbedoOpacity",O=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[I]=O;var N="pbrBlockReflectivity",T=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[N]=T;var L="pbrBlockAmbientOcclusion",M=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[L]=M;var g="pbrBlockAlphaFresnel",D=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]=D;var h="pbrBlockAnisotropic",_=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[h]=_;var F="pbrBlockReflection",P=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[F]=P;var U="pbrBlockSheen",b=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[U]=b;var B="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[B]=G;var y="pbrBlockIridescence",V=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[y]=V;var x="pbrBlockSubSurface",H=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[x]=H;var W="pbrBlockNormalGeometric",k=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[W]=k;var X="pbrBlockNormalFinal",w=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[X]=w;var Y="pbrBlockLightmapInit",z=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[Y]=z;var K="pbrBlockGeometryInfo",q=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]=q;var Z="pbrBlockReflectance0",J=`var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStoreWGSL[Z]=J;var j="pbrBlockReflectance",Q=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[j]=Q;var $="pbrBlockDirectLighting",ee=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[$]=ee;var re="pbrBlockFinalLitComponents",ie=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[re]=ie;var ae="pbrBlockFinalUnlitComponents",ne=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,vec3f(0.0));finalDiffuse*=uniforms.vLightingIntensity.x;var finalAmbient: vec3f=uniforms.vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;var finalEmissive: vec3f=uniforms.vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStoreWGSL[ae]=ne;var fe="pbrBlockFinalColorComposition",oe=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[fe]=oe;var te="pbrBlockImageProcessing",ce=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[te]=ce;var le="pbrBlockPrePass",de=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[le]=de;var se="pbrDebug",Ee=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[se]=Ee;var r="pbrPixelShader",i=`#define CUSTOM_FRAGMENT_BEGIN
...
}`;e.ShadersStoreWGSL[r]=i;var _i={name:r,shader:i};export{_i as a};
