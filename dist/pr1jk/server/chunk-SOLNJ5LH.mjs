...
import{a as e}from"./chunk-NW7RVBCE.mjs";var i="lineVertexShader",n=`#define ADDITIONAL_VERTEX_DECLARATION
...
}`;e.ShadersStoreWGSL[i]=n;var v={name:i,shader:n};export{v as a};
