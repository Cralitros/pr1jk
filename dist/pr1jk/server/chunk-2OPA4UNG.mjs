...
import{a as e}from"./chunk-NW7RVBCE.mjs";var l="colorCorrectionPixelShader",r=`uniform sampler2D textureSampler; 
...
void main(void)
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;e.ShadersStore[l]=r;var t={name:l,shader:r};export{t as a};
