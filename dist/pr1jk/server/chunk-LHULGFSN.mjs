...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblShadowSpatialBlurPixelShader",a=`#define PI 3.1415927
...
fragmentOutputs.color= vec4f(X.x/X.z,X.y/X.z,0.0,1.0);}`;e.ShadersStoreWGSL[r]=a;var o={name:r,shader:a};export{o as a};
