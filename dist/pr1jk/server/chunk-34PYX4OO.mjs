...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="fluidRenderingParticleDepthPixelShader",i=`uniform projection: mat4x4f;varying uv: vec2f;varying viewPos: vec3f;varying sphereRadius: f32;
...
`;e.ShadersStoreWGSL[r]=i;var n={name:r,shader:i};export{n as a};
