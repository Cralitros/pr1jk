...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblShadowSpatialBlurPixelShader",o=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(X.x/X.z,X.y/X.z,1.0,1.0);}`;e.ShadersStore[r]=o;var l={name:r,shader:o};export{l as a};
