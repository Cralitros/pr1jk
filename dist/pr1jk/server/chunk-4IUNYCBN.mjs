...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblShadowsImportanceSamplingDebugPixelShader",f=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;e.ShadersStoreWGSL[r]=f;var a={name:r,shader:f};export{a};
