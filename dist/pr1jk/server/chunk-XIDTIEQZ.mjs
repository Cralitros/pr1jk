...
import{a as e}from"./chunk-NW7RVBCE.mjs";var o="tonemapPixelShader",r=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float _ExposureAdjustment;
...
#endif
gl_FragColor=vec4(colour.rgb,1.0);}`;e.ShadersStore[o]=r;var l={name:o,shader:r};export{l as a};
