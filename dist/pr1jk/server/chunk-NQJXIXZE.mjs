...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="glowMapMergePixelShader",a=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
#ifdef EMISSIVE
...
}`;e.ShadersStoreWGSL[r]=a;var o={name:r,shader:a};export{o as a};
