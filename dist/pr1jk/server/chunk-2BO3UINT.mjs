...
`;e.IncludesShadersStore[a]=r;var o="pbrFragmentExtraDeclaration",t=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[o]=t;var f="samplerFragmentAlternateDeclaration",c=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[f]=c;var l="pbrFragmentSamplersDeclaration",d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[l]=d;var s="subSurfaceScatteringFunctions",E=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[s]=E;var R="pbrHelperFunctions",C=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[R]=C;var m="pbrDirectLightingSetupFunctions",A=`struct preLightingInfo
...
#endif
return result;}`;e.IncludesShadersStore[m]=A;var S="pbrDirectLightingFalloffFunctions",u=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[S]=u;var I="pbrDirectLightingFunctions",v=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[I]=v;var O="pbrIBLFunctions",p=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[O]=p;var N="pbrBlockAlbedoOpacity",T=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[N]=T;var L="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[L]=g;var M="pbrBlockAmbientOcclusion",D=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[M]=D;var _="pbrBlockAlphaFresnel",h=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[_]=h;var F="pbrBlockAnisotropic",P=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[F]=P;var b="pbrBlockReflection",U=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[b]=U;var B="pbrBlockSheen",y=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[B]=y;var G="pbrBlockClearcoat",V=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[G]=V;var H="pbrBlockIridescence",x=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[H]=x;var W="pbrBlockSubSurface",X=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[W]=X;var k="pbrBlockNormalGeometric",Y=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[k]=Y;var w="pbrBlockNormalFinal",z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[w]=z;var K="pbrBlockLightmapInit",q=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[K]=q;var Z="pbrBlockGeometryInfo",J=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[Z]=J;var j="pbrBlockReflectance0",Q=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[j]=Q;var $="pbrBlockReflectance",ee=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[$]=ee;var ie="pbrBlockDirectLighting",ne=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[ie]=ne;var ae="pbrBlockFinalLitComponents",re=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[ae]=re;var oe="pbrBlockFinalUnlitComponents",te=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,0.0);finalDiffuse*=vLightingIntensity.x;vec3 finalAmbient=vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;vec3 finalEmissive=vEmissiveColor;
#ifdef EMISSIVE
...
`;e.IncludesShadersStore[oe]=te;var fe="pbrBlockFinalColorComposition",ce=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[fe]=ce;var le="pbrBlockImageProcessing",de=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[le]=de;var se="pbrBlockPrePass",Ee=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[se]=Ee;var Re="pbrDebug",Ce=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Re]=Ce;var i="pbrPixelShader",n=`#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
`;e.ShadersStore[i]=n;var Vn={name:i,shader:n};export{Vn as a};
