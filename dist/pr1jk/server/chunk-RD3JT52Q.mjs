...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="tonemapPixelShader",o=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform _ExposureAdjustment: f32;
...
#endif
fragmentOutputs.color= vec4f(colour.rgb,1.0);}`;e.ShadersStoreWGSL[r]=o;var u={name:r,shader:o};export{u as a};
