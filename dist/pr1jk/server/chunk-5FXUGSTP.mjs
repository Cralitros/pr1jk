...
import{a as e}from"./chunk-NW7RVBCE.mjs";var a="circleOfConfusionPixelShader",r=`varying vUV: vec2f;var depthSamplerSampler: sampler;var depthSampler: texture_2d<f32>;
...
`;e.ShadersStoreWGSL[a]=r;var n={name:a,shader:r};export{n as a};
