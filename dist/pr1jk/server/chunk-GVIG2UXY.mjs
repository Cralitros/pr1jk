...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="motionBlurPixelShader",o=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float motionStrength;uniform float motionScale;uniform vec2 screenSize;
#ifdef OBJECT_BASED
...
`;e.ShadersStore[t]=o;var i={name:t,shader:o};export{i as a};
