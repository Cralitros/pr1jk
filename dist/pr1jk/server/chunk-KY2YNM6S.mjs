...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="screenSpaceReflection2PixelShader",i=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;e.ShadersStore[t]=i;var c={name:t,shader:i};export{c as a};
