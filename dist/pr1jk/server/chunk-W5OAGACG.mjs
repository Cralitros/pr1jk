...
import{a as e}from"./chunk-NW7RVBCE.mjs";var c="circleOfConfusionPixelShader",a=`uniform sampler2D depthSampler;varying vec2 vUV;
...
`;e.ShadersStore[c]=a;var i={name:c,shader:a};export{i as a};
