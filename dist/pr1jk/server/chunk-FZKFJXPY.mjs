...
import{a as e}from"./chunk-NW7RVBCE.mjs";var o="bayerDitherFunctions",i=`float bayerDither2(vec2 _P) {return mod(2.0*_P.y+_P.x+1.0,4.0);}
...
`;e.IncludesShadersStore[o]=i;var t="shadowMapFragmentExtraDeclaration",n=`#if SM_FLOAT==0
...
varying float zSM;
#endif
`;e.IncludesShadersStore[t]=n;var a="shadowMapPixelShader",r=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStore[a]=r;var T={name:a,shader:r};export{T as a};
