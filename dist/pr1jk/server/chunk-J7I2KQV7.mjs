...
import{a as e}from"./chunk-NW7RVBCE.mjs";var i="glowMapGenerationVertexShader",t=`attribute position: vec3f;
...
}`;e.ShadersStoreWGSL[i]=t;var l={name:i,shader:t};export{l as a};
