...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="ssao2PixelShader",o=`precision highp float;uniform sampler2D textureSampler;varying vec2 vUV;
#ifdef SSAO
...
#endif
`;e.ShadersStore[t]=o;var r={name:t,shader:o};export{r as a};
