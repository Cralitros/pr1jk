...
import{a as r}from"./chunk-NW7RVBCE.mjs";var e="vrDistortionCorrectionPixelShader",t=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;r.ShadersStoreWGSL[e]=t;var n={name:e,shader:t};export{n as a};
