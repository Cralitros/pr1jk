...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblShadowAccumulationPixelShader",a=`varying vUV: vec2f;uniform accumulationParameters: vec4f;
...
mix(PrevShadows.y,newShadows.y,PrevShadows.z),PrevShadows.z,1.0);}`;e.ShadersStoreWGSL[r]=a;var t={name:r,shader:a};export{t as a};
