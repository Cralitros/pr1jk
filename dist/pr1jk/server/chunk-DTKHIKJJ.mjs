...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="iblShadowVoxelTracingPixelShader",i=`precision highp sampler2D;precision highp sampler3D;
#define PI 3.1415927
varying vec2 vUV;
...
#endif
}`;e.ShadersStore[t]=i;var o={name:t,shader:i};export{o as a};
