...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="glowBlurPostProcessPixelShader",r=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
...
gl_FragColor=baseColor;}`;e.ShadersStore[t]=r;var i={name:t,shader:r};export{i as a};
