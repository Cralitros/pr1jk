...
import{a as e}from"./chunk-NW7RVBCE.mjs";var o="screenSpaceReflection2BlurPixelShader",a=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;e.ShadersStore[o]=a;var r={name:o,shader:a};export{r as a};
