...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="lodCubePixelShader",t=`const GammaEncodePowerApprox=1.0/2.2;varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_cube<f32>;uniform lod: f32;uniform gamma: i32;@fragment
...
`;e.ShadersStoreWGSL[r]=t;var m={name:r,shader:t};export{m as a};
