...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="fluidRenderingParticleDepthVertexShader",i=`attribute position: vec3f;attribute offset: vec2f;uniform view: mat4x4f;uniform projection: mat4x4f;uniform size: vec2f;varying uv: vec2f;varying viewPos: vec3f;varying sphereRadius: f32;
...
`;e.ShadersStoreWGSL[t]=i;var o={name:t,shader:i};export{o as a};
