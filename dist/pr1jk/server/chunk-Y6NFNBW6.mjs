...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="screenSpaceReflection2PixelShader",t=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;
#ifdef SSR_SUPPORTED
...
`;e.ShadersStoreWGSL[r]=t;var a={name:r,shader:t};export{a};
