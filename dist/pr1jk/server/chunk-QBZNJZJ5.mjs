...
import{a as e}from"./chunk-NW7RVBCE.mjs";var o="fresnelFunction",i=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[o]=i;var r="defaultPixelShader",f=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[r]=f;var U={name:r,shader:f};export{U as a};
