...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="convolutionPixelShader",t=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform kernel: array<f32,9>;
...
fragmentOutputs.color= vec4f((colorSum/kernelWeight).rgb,1);}`;e.ShadersStoreWGSL[r]=t;var l={name:r,shader:t};export{l as a};
