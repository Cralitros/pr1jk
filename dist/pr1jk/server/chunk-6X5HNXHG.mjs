...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="depthOfFieldMergePixelShader",l=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;e.ShadersStore[r]=l;var o={name:r,shader:l};export{o as a};
