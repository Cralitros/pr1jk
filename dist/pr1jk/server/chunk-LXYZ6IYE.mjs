...
import{a as e}from"./chunk-NW7RVBCE.mjs";var i="imageProcessingCompatibility",a=`#ifdef IMAGEPROCESSINGPOSTPROCESS
fragmentOutputs.color=vec4f(pow(fragmentOutputs.color.rgb, vec3f(2.2)),fragmentOutputs.color.a);
#endif
`;e.IncludesShadersStoreWGSL[i]=a;var r="spritesPixelShader",t=`uniform alphaTest: i32;varying vColor: vec4f;varying vUV: vec2f;var diffuseSamplerSampler: sampler;var diffuseSampler: texture_2d<f32>;
...
}`;e.ShadersStoreWGSL[r]=t;var l={name:r,shader:t};export{l as a};
