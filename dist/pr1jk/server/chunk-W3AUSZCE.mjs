...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="glowBlurPostProcessPixelShader",t=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform direction: vec2f;uniform blurWidth: f32;fn getLuminance(color: vec3f)->f32
...
fragmentOutputs.color=baseColor;}`;e.ShadersStoreWGSL[r]=t;var o={name:r,shader:t};export{o as a};
