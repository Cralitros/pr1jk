...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="shadowMapVertexMetric",i=`#if SM_USEDISTANCE==1
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]=i;var S={name:t,shader:i};export{S as a};
