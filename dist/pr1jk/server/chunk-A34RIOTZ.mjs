...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="iblGenerateVoxelMipPixelShader",u=`varying vUV: vec2f;var srcMip: texture_3d<f32>;uniform layerNum: i32;@fragment
...
<< 7u);fragmentOutputs.color=vec4f( f32(tex)/255.0f,0.0f,0.0f,1.0);}`;e.ShadersStoreWGSL[r]=u;var o={name:r,shader:u};export{o as a};
