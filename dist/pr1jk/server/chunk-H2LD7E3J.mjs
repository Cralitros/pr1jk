...
import{a as r}from"./chunk-NW7RVBCE.mjs";var e="reflectionFunction",o=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;r.IncludesShadersStoreWGSL[e]=o;var f={name:e,shader:o};export{f as a};
