...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="outlineVertexShader",i=`attribute position: vec3f;attribute normal: vec3f;
...
`;e.ShadersStoreWGSL[t]=i;var U={name:t,shader:i};export{U as a};
