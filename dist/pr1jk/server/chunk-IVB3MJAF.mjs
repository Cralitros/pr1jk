...
import{a as e}from"./chunk-NW7RVBCE.mjs";var a="bumpFragment",r=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[a]=r;var n={name:a,shader:r};export{n as a};
