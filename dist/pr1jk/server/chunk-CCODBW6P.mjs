...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="shadowMapFragment",S=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
...
#endif
`;e.IncludesShadersStoreWGSL[t]=S;var s={name:t,shader:S};export{s as a};
