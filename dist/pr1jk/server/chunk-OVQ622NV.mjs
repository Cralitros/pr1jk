...
import{a as e}from"./chunk-NW7RVBCE.mjs";var t="spritesVertexShader",r=`attribute position: vec4f;attribute options: vec2f;attribute offsets: vec2f;attribute inverts: vec2f;attribute cellInfo: vec4f;attribute color: vec4f;uniform view: mat4x4f;uniform projection: mat4x4f;varying vUV: vec2f;varying vColor: vec4f;
...
}`;e.ShadersStoreWGSL[t]=r;var f={name:t,shader:r};export{f as a};
