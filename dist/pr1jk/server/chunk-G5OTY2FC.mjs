...
import{a as e}from"./chunk-NW7RVBCE.mjs";var r="fluidRenderingParticleDepthPixelShader",i=`uniform mat4 projection;varying vec2 uv;varying vec3 viewPos;varying float sphereRadius;
...
`;e.ShadersStore[r]=i;var a={name:r,shader:i};export{a};
